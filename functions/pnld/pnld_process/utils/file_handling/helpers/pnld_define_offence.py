...
def define_offence(record, terminal_entries, ingestion_type, uploaded_by, rp_id):
    ...
    current_time = current_time_raw.strftime("%Y-%m-%dT%H:%M:%S.%f")[:-3] + "Z"
    current_date = current_time_raw.strftime("%Y-%m-%d")
    ...
    output_record = {
               # "OffenceRevisionID": 0,
                ...
                "OffenceNotes":  f"PNLD Upload - {current_date}",
                ...
                "PNLDStandardOffenceWording": record['SOW_CLEANSED'], # raw or cleansed or final?
                ...
                "UserOffenceWording": record['SOW'],
                "UserStatementOfFacts": record['SOF'],
                ...
                # "Prefix": "string",
                "ObsoleteIndicator": "N",
                "SysPNLDDataHash": record['md5_hash'],
