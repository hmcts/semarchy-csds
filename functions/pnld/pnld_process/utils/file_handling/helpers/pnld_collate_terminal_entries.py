...
def process_menus(cjs_code, terminal_entries, menus, menu_options):
    ...
    for menu in menus:
        ...
        import re
        menu_number = re.search(r"SPECIFY VALUE (\d+)", prompt).group(1)
        updated_menu["name"] = f"PNLD Menu ({cjs_code}): {menu_number}"
    ...
    for opt in menu_options:
        ...
        new_opt["SysPNLDMenuDataHash"] = md5_mapping[raw_menu_md5]
