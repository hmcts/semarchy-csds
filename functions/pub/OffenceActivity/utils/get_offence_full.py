...
def build_payload_get_offence_full(offence_details: dict, pss_offence_id: int) -> dict:
    """
    Extracts the required Offence attributes from the Semarchy Named Query response.
    """

    payload = {
            "OFR_ID": pss_offence_id,
            "Status": "DRAFT",
        "AuditingInformation": {
...
def build_soap_xml_get_offence_full(json_obj: dict) -> str:
    """
    ...
    envelope = ET.Element(
        ...
        attrib={
            ...
            "xmlns:ns56": "http://www.justice.gov.uk/magistrates/pss/GetOffenceFullRequest",
            "xmlns:ns115": "http://www.justice.gov.uk/magistrates/pss/GatewayMessageSchema",
    ...
    ET.SubElement(header, "wsa:Action").text = "getOffenceFull"
    ...
    payload = ET.SubElement(body, "ns56:GetOffenceFullRequest")
